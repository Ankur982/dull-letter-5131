    ...
    <div id="nav5">
        <ul>
            <li><a href="#">New</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All New</a></li>
                        <li><a href="" className='hover-item-li'>Just Dropped</a></li>
                        <li><a href="" className='hover-item-li'>New Makeup</a></li>
                        <li><a href="" className='hover-item-li'>New Skincare</a></li>
                        <li><a href="" className='hover-item-li'>New Haircare</a></li>
                        <li><a href="" className='hover-item-li'>New Fragrance</a></li>
                        <li><a href="" className='hover-item-li'>New Bath & Body</a></li>
                        <li><a href="" className='hover-item-li'>New Tools & Brushes</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>The Next Big Thing</a></li>
                        <li><a href="" className='hover-item-li'>Bestsellers</a></li>
            ...
            <li><a href="">Brands</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>Brands A-Z</a></li>
                        <li><a href="" className='hover-item-li'>SEPHORA COLLECTION</a></li>
                        <li><a href="" className='hover-item-li'>New Brands</a></li>
                        <li><a href="">The Outset</a></li>
                        <li><a href="">HAUS LABS BY LADY GAGA</a></li>
                        <li><a href="">Abbott NYC</a></li>
                        <li><a href="">GXVE Beauty</a></li>
                        <li><a href="">Kate Mcleod</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Only At Sephora</a></li>
                        <li><a href="">Paula's Choice</a></li>
                        <li><a href="">InnBeauty Project</a></li>
                    ...
                    <ul>
                        <li><a href="" className='hover-item-li'>Black-Owned Brands</a></li>
                        <li><a href="">Shani Darden Skin Care</a></li>
                        <li><a href="">Adowa Beauty</a></li>
                        <li><a href="">PATTERN By Tracee Ellis Ross</a></li>
                        <li><a href="">Briogeo</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Clean At Sephora</a></li>
                        <li><a href="">ILIA</a></li>
                        <li><a href="">Olaplex</a></li>
                        <li><a href="">Tatcha</a></li>
                        <li><a href="">Ellis Brooklyn</a></li>
                    </ul>
                </div>
            </li>
            <li><a href="">Makeup</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Makeup</a></li>
                        <li><a href="" className='hover-item-li'>Face</a></li>
                        <li><a href="">Foundation</a></li>
                        <li><a href="">BB & CC Creams</a></li>
                        <li><a href="">Tinted Moisturizer</a></li>
                        <li><a href="">Concealer</a></li>
                        <li><a href="">Face Printer</a></li>
                        <li><a href="">Setting Spray & Powder</a></li>
                    ...
                    <ul>
                        <li><a href="" className='hover-item-li'>Eye</a></li>
                    ...
                    <ul>
                        <li><a href="" className='hover-item-li'>Cheek</a></li>
                        <li><a href="">Blush</a></li>
                        <li><a href="">Bronzer</a></li>
                        <li><a href="">Cheek Palettes</a></li>
                        <li><a href="" className='hover-item-li'>Value & Gift Sets</a></li>
                        <li><a href="" className='hover-item-li'>Makeup Palettes</a></li>
                        <li><a href="" className='hover-item-li'>Brushes and Applicators</a></li>
                        <li><a href="" className='hover-item-li'>Accessories</a></li>
                        <li><a href="" className='hover-item-li'>Nail</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>New</a></li>
                        <li><a href="" className='hover-item-li'>BestSellers</a></li>
                        <li><a href="" className='hover-item-li'>Clean Makeup</a></li>
                        <li><a href="" className='hover-item-li'>Vegan Makeup</a></li>
                        <li><a href="" className='hover-item-li'>Mini Size</a></li>
                        <li><a href="" className='hover-item-li'>Value Size</a></li>
                        <li><a href="" className='hover-item-li'>Sephora Collection</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Help Me Choose</a></li>
                        <li><a href="">Foundation Quiz</a></li>
                        <li><a href="">Lip Quiz</a></li>
                        <li><a href="">Brow QUiz</a></li>
                        <li><a href="">Complexion Routine Builder</a></li>
                        <li><a href="">Guide to Foundation</a></li>
                        <li><a href="">Clean Makeup Guide</a></li>
                        <li><a href="">No Makeup Makeup</a></li>
                        <li><a href="">Allure Best On Beauty Makeup</a></li>
                    </ul>
                </div>
            </li>
            <li><a href="">Skincare</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Skincare</a></li>
                        <li><a href="" className='hover-item-li'>Moisturizers</a></li>
                        <li><a href="">Night Creams</a></li>
                        <li><a href="">Face Oils</a></li>
                        <li><a href="">Mists & Essences</a></li>
                        <li><a href="">BB & CC Creams</a></li>
                        <li><a href="" className='hover-item-li'>Cleansers</a></li>
                        <li><a href="">Face Wash & Cleansers</a></li>
                        <li><a href="">Exfoliaters</a></li>
                        <li><a href="">Makeup Removers</a></li>
                        <li><a href="">Face Wipes</a></li>
                        <li><a href="">Toners</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Treatments</a></li>
                        <li><a href="">Face Serums</a></li>
                        <li><a href="">Blemish & Acne Treatments</a></li>
                        <li><a href="">Facial Peels</a></li>
                        <li><a href="" className='hover-item-li'>Masks</a></li>
                        <li><a href="">Face Masks</a></li>
                        <li><a href="">Sheet Masks</a></li>
                        <li><a href="">Eye Masks</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Eye Care</a></li>
                        <li><a href="">Eye Creams & Treatments</a></li>
                        <li><a href="">Eye Masks</a></li>
                        <li><a href="" className='hover-item-li'>Lip Balms & Treatments</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>SunScreen</a></li>
                        <li><a href="">Face Sunscreen</a></li>
                        <li><a href="">Body Sunscreen</a></li>
                        <li><a href="" className='hover-item-li'>High Tech Tools</a></li>
                        <li><a href="" className='hover-item-li'>Wellness</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Shop By Concern</a></li>
                        ...
                        <li><a href="">Fine Line & Wrinkles</a></li>
                        <li><a href="">Dullness</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>New</a></li>
                        <li><a href="" className='hover-item-li'>Best Sellers</a></li>
                        <li><a href="" className='hover-item-li'>Vegan Skincare</a></li>
                        <li><a href="" className='hover-item-li'>Value And Giftsets</a></li>
                        <li><a href="" className='hover-item-li'>Mini Size</a></li>
                        <li><a href="" className='hover-item-li'>value Size</a></li>
                        <li><a href="" className='hover-item-li'>Sephora Collection</a></li>
                    </ul>
                    <ul>
                        ...
                        <li><a href="">Skin Routine Quiz</a></li>
                        <li><a href="">Clinnical Skincare</a></li>
                        <li><a href="">Skincare Ingredients</a></li>
                        <li><a href="">Best Skincare under $35</a></li>
                        <li><a href="">Clean Skincare Guide</a></li>
                        <li><a href="">Skincare By Age</a></li>
                        <li><a href="">SkinCare for Your Skin Type</a></li>
                        <li><a href="">Allure Best Of Beauty Skincare</a></li>
                    </ul>
                </div>
            </li>
            <li><a href="">Hair</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Hair</a></li>
                        <li><a href="" className='hover-item-li'>Shampoo & Conditioners</a></li>
                    ...
                    <ul>
                        ...
                        <li><a href="">Leave-In Conditioners</a></li>
                        <li><a href="">Hair Oils</a></li>
                        <li><a href="">Hair Serums</a></li>
                        <li><a href="">Scalp Treatments</a></li>
                        <li><a href="">Hair Supplements</a></li>
                        <li><a href="">Hair Thinning & Hair Loss</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Styling</a></li>
                        <li><a href="">Styling Creams</a></li>
                        <li><a href="">Dry Shampoo</a></li>
                        <li><a href="">Hair Primers</a></li>
                        <li><a href="">Hair Spray</a></li>
                        <li><a href="" className='hover-item-li'>Curly,Coily,Textured Haircare</a></li>
                        <li><a href="" className='hover-item-li'>Hair Dye & Root Touchups</a></li>
                        <li><a href="">Hair Toners</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Value & GiftSets</a></li>
                        <li><a href="" className='hover-item-li'>Tools</a></li>
                        <li><a href="">Hair Dryers</a></li>
                        <li><a href="">Hair Straightners & Fist Irons</a></li>
                        <li><a href="">Curling Irons</a></li>
                        <li><a href="" className='hover-item-li'>Brushes & Combs</a></li>
                        <li><a href="" className='hover-item-li'>Accessories</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Shop BY Concern</a></li>
                        ...
                        <li><a href="">Color Care</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>New</a></li>
                        <li><a href="" className='hover-item-li'>Best Sellers</a></li>
                        <li><a href="" className='hover-item-li'>Clean Haircare</a></li>
                        <li><a href="" className='hover-item-li'>Vegan Haircare</a></li>
                        <li><a href="" className='hover-item-li'>Mini Size</a></li>
                        <li><a href="" className='hover-item-li'>Value Size</a></li>
                        <li><a href="" className='hover-item-li'>Sephora Collection</a></li>
                        <li><a href="" className='hover-item-li'>Luxury Hair</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Help Me Choose</a></li>
                        <li><a href="">Hair Quiz</a></li>
                        <li><a href="">Clean Hair Care Guide</a></li>
                        <li><a href="">Curly,Coily,Textured Haircare Guide</a></li>
                        <li><a href="">Healty Hair Care Guide</a></li>
                        <li><a href="">Allure Best Of Beauty Hair</a></li>
                    </ul>
                </div>
            </li>
            <li><a href="">Fragrance</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Fragrance</a></li>
                        <li><a href="" className='hover-item-li'>Women</a></li>
                        <li><a href="">Perfume</a></li>
                        <li><a href="">Perfume Oils</a></li>
                        <li><a href="">RollerBalls & Travel Size</a></li>
                        <li><a href="">Body Mist & Hair Mist</a></li>
                        <li><a href="" className='hover-item-li'>Men</a></li>
                        <li><a href="">Cologne</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Value & Gift Sets</a></li>
                        <li><a href="">Perfume Gift Sets</a></li>
                        <li><a href="">Cologne Gift Sets</a></li>
                        <li><a href="">Home Gift Sets</a></li>
                        <li><a href="">Sephora Favorites</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Candles & Home Scents</a></li>
                        <li><a href="">Cnadles</a></li>
                        <li><a href="">Diffusers</a></li>
                        <li><a href="" className='hover-item-li'>Shop By Fragrance Family</a></li>
                        <li><a href="">Floral</a></li>
                        <li><a href="">Fresh</a></li>
                        <li><a href="">Warm & Spicy</a></li>
                        <li><a href="">Earthly & Woody</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>New</a></li>
                        <li><a href="" className='hover-item-li'>Bestsellers</a></li>
                        <li><a href="" className='hover-item-li'>Clean Fragrance</a></li>
                        <li><a href="" className='hover-item-li'>Vegan Fragrance</a></li>
                        <li><a href="" className='hover-item-li'>Mini Size</a></li>
                        <li><a href="" className='hover-item-li'>Value Size</a></li>
                        <li><a href="" className='hover-item-li'>Luxury Fragrance</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Help Me Choose</a></li>
                        <li><a href="">Clean Fragrance Guide</a></li>
                        <li><a href="">Fragrance Quiz</a></li>
                        <li><a href="">Fragrance Notes Guide</a></li>
                        <li><a href="">Best Affordable Fragrance</a></li>
                        <li><a href="">Niche Fragrance</a></li>
                        <li><a href="">Next Big Thing</a></li>
                        <li><a href="">Allure Best of Beauty Fragrance</a></li>
                    </ul>
                </div>
            </li>
            <li><a href="">Tools & Brushes</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Tools & Brushes</a></li>
                        <li><a href="" className='hover-item-li'>Sephora Collection</a></li>
                        <li><a href="" className='hover-item-li'>Brushes & Applications</a></li>
                        ...
                        <li><a href="">Facial Cleansing Brushes</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Hair Tools</a></li>
                        <li><a href="">Hair Dryers</a></li>
                        <li><a href="">Straightners & Flat Irons</a></li>
                        <li><a href="">Brushes & Combs</a></li>
                        <li><a href="">Accessories</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Beauty Tools</a></li>
                        <li><a href="">Anti-Aging</a></li>
                        <li><a href="">Teeth Whitening</a></li>
                        <li><a href="">Hair Removal</a></li>
                        <li><a href="">Tweezers & Eyebrows</a></li>
                        <li><a href="">Manicure & Pedicure</a></li>
                        <li><a href="">Eyelash Curlers</a></li>
                        <li><a href="">Sharpners</a></li>
                        <li><a href="" className='hover-item-li'>Vibrators & Devices</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>MakeUp & travle Cases</a></li>
                        <li><a href="" className='hover-item-li'>Value & Gift Sets</a></li>
                        <li><a href="" className='hover-item-li'>New</a></li>
                        <li><a href="" className='hover-item-li'>BestSellers</a></li>
            ...
            <li><a href="">Bath & Body</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Bath & Body</a></li>
                        <li><a href="" className='hover-item-li'>Bath & Body Shower</a></li>
                        <li><a href="">Body Wash & Shower Gel</a></li>
                        <li><a href="">Scrub & Exfoliants</a></li>
                        <li><a href="">Bath Soaks & Bubble Bath</a></li>
                        <li><a href="" className='hover-item-li'>Body Moisturizers</a></li>
                        <li><a href="">Body Lotions & Body Oils</a></li>
                        <li><a href="">Hand Cream And Foot Creams</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Body Care</a></li>
                        <li><a href="">Intimate Care</a></li>
                        <li><a href="">Hand Sanitizers</a></li>
                        <li><a href="">Cellulite & Stretch Masks</a></li>
                        <li><a href="">Deodorant & Antiperspirent</a></li>
                        <li><a href="" className='hover-item-li'>Value & Gift Sets</a></li>
                        <li><a href="" className='hover-item-li'>Shop By Concern</a></li>
                        <li><a href="">Stretch Marks & Firming</a></li>
                        <li><a href="">Hydration</a></li>
                        <li><a href="">Smooth Texture</a></li>
                        <li><a href="">Even Skin Tone and COlor Correction</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Candle and Home Scents</a></li>
                        <li><a href="" className='hover-item-li'>Sunscreens</a></li>
                        <li><a href="">Face Sunscreen</a></li>
                        <li><a href="">Body Sunscreen</a></li>
                        <li><a href="" className='hover-item-li'>Self Tanners</a></li>
                        <li><a href="" className='hover-item-li'>Beauty Supplements</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>New</a></li>
                        <li><a href="" className='hover-item-li'>BestSellers</a></li>
            ...
            <li><a href="">Mini Size</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Mini Size</a></li>
                        <li><a href="" className='hover-item-li'>Makeup</a></li>
                        <li><a href="" className='hover-item-li'>Skincare</a></li>
                        <li><a href="" className='hover-item-li'>Hair</a></li>
                        <li><a href="" className='hover-item-li'>Fragrance</a></li>
                        <li><a href="" className='hover-item-li'>Bath and Body</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Value & Gift Sets</a></li>
                        <li><a href="" className='hover-item-li'>$15 and Under</a></li>
                        <li><a href="" className='hover-item-li'>$25 and Under</a></li>
            ...
            <li><a href="">🎆Gifts</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Gifts</a></li>
                        <li><a href="" className='hover-item-li'>Gift Finder</a></li>
                        <li><a href="" className='hover-item-li'>Gift Cards</a></li>
                        <li><a href="" className='hover-item-li'>Value and Gift Sets</a></li>
                        <li><a href="" className='hover-item-li'>By Price</a></li>
                        <li><a href="">$10 and Under</a></li>
                        <li><a href="">$15 and Under</a></li>
                        <li><a href="">$25 and Under</a></li>
                        <li><a href="">$50 and Under</a></li>
                        <li><a href="">$75 and Under</a></li>
                        <li><a href="">$100 and Under</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>By Category</a></li>
                        <li><a href="">Makeup</a></li>
                        <li><a href="">Skincare</a></li>
                        <li><a href="">Hair</a></li>
                        <li><a href="">Fragrance</a></li>
                        <li><a href="">Candles and Home Scents</a></li>
                        <li><a href="">Tools</a></li>
                        <li><a href="">Brush Sets and Accessories</a></li>
                        <li><a href="">Bath and Body</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>By Recipient</a></li>
                    ...
                    <ul>
                        <li><a href="" className='hover-item-li'>Top Rated Gifts</a></li>
                        <li><a href="" className='hover-item-li'>Mini Size</a></li>
                        <li><a href="" className='hover-item-li'>Only At Sephora</a></li>
                        <li><a href="" className='hover-item-li'>Luxury</a></li>
                        <li><a href="" className='hover-item-li'>Gift Finder</a></li>
                    </ul>
                    <ul>
                        <li><a href=""><img
            ...
            <li><a href="">Beauty Under $20</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>Makeup Under $20</a></li>
                        <li><a href="" className='hover-item-li'>Skincare Under $20</a></li>
                        <li><a href="" className='hover-item-li'>Hair Under $20</a></li>
                        <li><a href="" className='hover-item-li'>Fragrance Under $20</a></li>
                        <li><a href="" className='hover-item-li'>Tools & Brushes Under $20</a></li>
                        <li><a href="" className='hover-item-li'>Bath and Body Under $20</a></li>
                    </ul>
                    <ul>
                        <li><a href="" className='hover-item-li'>Sephora Collection Under $20</a></li>
                        <li><a href="">Makeup</a></li>
                        <li><a href="">Skincare</a></li>
                        <li><a href="">Hair</a></li>
                        <li><a href="">Candles</a></li>
                        <li><a href="">Tools and Brushes</a></li>
                        <li><a href="">Bath And Body</a></li>
            ...
            <li><a href="">Sale & Offers</a>
                <div>
                    <ul>
                        <li><a href="" className='hover-item-li'>All Sale</a></li>
                        <li><a href="" className='hover-item-li'>Makeup</a></li>
                        <li><a href="" className='hover-item-li'>Skincare</a></li>
                        <li><a href="" className='hover-item-li'>Haircare</a></li>
                        <li><a href="" className='hover-item-li'>Fragrance</a></li>
                        <li><a href="" className='hover-item-li'>Tools and Brushes</a></li>
                        <li><a href="" className='hover-item-li'>Bath And Body</a></li>
                        <li><a href="" className='hover-item-li'>Mini Size</a></li>
                    </ul>
                    <ul>
