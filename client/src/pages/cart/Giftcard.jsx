   ...
   <Box className='gift-main'>
        ...
        <Box className='gift-2'>
            <Box className='gift-2-1'>
                ...
                <Box>
                    <Text fontSize={'1rem'} fontWeight={600} mt='0.2rem'>Add a Sephora gift card</Text>
                    <Text fontSize={'0.8rem'}>The super-east gift on everyone's list</Text>
                </Box>
            </Box>
        ...
        <Box className='assist'>
            <Text fontSize={'1rem'} fontWeight={600}>Need Assistance?</Text>
            <Text fontSize={'0.9rem'} mt='0.5rem'>1-877-SEPHORA (1-877-737-4672)</Text>
            <Link to='#'><Text className='g-link' fontSize={'0.9rem'}>TTY: 1-888-866-9845</Text></Link>
            <Link to='#'><Text className='g-link' mt='0.5rem' fontSize={'0.9rem'}>Free retrun shippping or return issue 🛈</Text></Link>
