...
const JustDropped = () => {
  ...
  return (
    ...
    <ItemsCarousel
      ...
      numberOfCards={6}
      gutter={8}
      leftChevron={ <div className="dropped_carousel_btn_box_L"> <ChevronLeftIcon boxSize={10} color='white'/> </div>}
      rightChevron={<div className="dropped_carousel_btn_box_R"> <ChevronRightIcon boxSize={10} color='white'/> </div>}
      outsideChevron
